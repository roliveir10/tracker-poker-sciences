/*
  ...
  - You are about to drop the column `resultPosition` on the `Tournament` table. All the data in the column will be lost.
...
INSERT INTO "new_Tournament" ("buyInCents", "createdAt", "gameId", "id", "importId", "prizeMultiplier", "profitCents", "rakeCents", "room", "startedAt", "userId") SELECT "buyInCents", "createdAt", "gameId", "id", "importId", "prizeMultiplier", "profitCents", "rakeCents", "room", "startedAt", "userId" FROM "Tournament";
